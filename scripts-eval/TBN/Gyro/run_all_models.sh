...
# DataEgo TBN Gyro 5개 모델 병렬 실행 스크립트
echo "========== DataEgo TBN Gyro 5 Models Parallel Execution =========="
...
echo "✅ All 5 Gyro models started in parallel!"
...
wait
echo "🎉 All Gyro models completed!"