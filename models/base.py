...
class BaseLearner(object):
    ...
    def _choose_optimizer(self):
        ...
        if 'Gyro' in self._modality and 'Acce' in self._modality:
            # Handle different fusion attribute names
            fusion_attr = 'fusion_network' if hasattr(self._network, 'fusion_network') else 'fusion'
            param_groups1 = [
                ...
                {'params': filter(lambda p: p.requires_grad, getattr(self._network, fusion_attr).parameters())},
