...
class AuxiliaryHeadFusionV2_8(nn.Module):
    """
    🔥 Auxiliary Head Pretrain 전략 기반 융합 모듈 (v2_8)
    ...
    def __init__(self, feature_dim, modality, dropout, num_classes=32, 
        ...
        if len(self.modality) <= 1:
            raise ValueError("AuxiliaryHeadFusionV2_8 requires multiple modalities")
    ...
    def forward(self, features, targets=None):
        ...
        if len(self.modality) > 1:
            ...
            # 🎯 v2_8: Pretrain에서는 균등 가중치, 이후에는 raw confidence 값 자체를 가중치로 사용
            if confidences:
        ...
        return {
            ...
            'fusion_type': 'auxiliary_head_v2_8',
